...
//print_r($_POST);
	...
	if (
		...
		<td height='15' align='center'><font size='-2'>{ICT}</font></td><td height='15' align='center'><font size='-2'>{IC1}</font></td>
		...
		$getreportyear = mysql_query("SELECT * FROM reports WHERE rid='$rid'");
			...
			// GET DATA FROM PREVIOUS INTERIM REPORT 2 AND SET VARIABLES FOR ITS COLUMN 											
						...
						/*------------------------------------ CHECK Attendance for ABSENT  ----------------------------*/
							...
							// ELSE, SET EDITABLE VARIABLES 
								...
								// ART					
								$t->set_var("ARTT","<input type='text' name='i_artt' value='$getarray[artt]' size='60' maxlength='200'>"); 
								$t->set_var("ART1","<input type='text' name='i_art1' value='$getarray[art1]' size='1' maxlength='4'>"); 
								$t->set_var("ART2","<input type='text' name='i_art2' value='$getarray[art2]' size='1' maxlength='4'>");	
								$t->set_var("ART3","<input type='text' name='i_art3' value='$getarray[art3]' size='1' maxlength='4'>");
								...
								$set = "rsid = '$stud_id', interim = '$i_interim',
											...
											artt = '$i_artt', art1 = '$i_art1', art2 = '$i_art2', art3 = '$i_art3', 

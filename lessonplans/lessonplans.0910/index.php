...
echo "<table border='0'><tr><td>$user_class (ex.: ICT G3)</td></tr>";
echo "<tr><td><input type='text' name='lclass' value='' size='20'></td></tr>";
echo "<tr><td>$user_name (ex.: Mr. David)</td>";
echo "<tr><td><input type='text' name='lname' value='' size='20'></td></tr>";
echo "</tr><tr><td></td>";
...
// LOOP TABLE HERE
echo "<table border='0' cellpadding='2' !bgcolor='black'><tr><td><b><h3>$user_class</h3></b></td><td>/</td><td><b><h3>$user_name</h3></b>";
...
echo "<tr><td><a href='week.php?luid=$luid'>$view</a>&nbsp;$lclass</td><td></td><td valign='bottom'>$lname";
...
//DISABLED this following line DELETE FONCTION FOR SAFETY REASONS (Do not want people to delete other ppl)---> 
